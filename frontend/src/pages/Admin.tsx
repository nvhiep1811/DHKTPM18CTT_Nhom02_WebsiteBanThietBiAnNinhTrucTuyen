      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="border-b border-gray-200 mb-8">
          <nav className="-mb-px flex space-x-8">
            {[
              ...
              { id: 'users', name: 'Khách hàng', icon: Users }
            ].map((tab) => (
              <button
                key={tab.id}
        ...
        {activeTab === 'orders' && (
          <div className="text-center py-12">
            <p className="text-gray-500">Trang quản lý đơn hàng đang được phát triển</p>
          </div>
        )}
        {activeTab === 'users' && (
          <div className="text-center py-12">
            <p className="text-gray-500">Trang quản lý khách hàng đang được phát triển</p>
          </div>
        )}
      </main>
